...
class ZobristHash:
    ...
    def create_hash_key(cls, board):
        """Creates a starting Zobrist key. Future keys will be
        generated by modifying the previous position's key.
        """
        hash_key = 0
        for piece_type in range(12):
            piece = board.bitboards[piece_type]
            while pieces:
                piece_square = tools.bitscan_lsb(piece)
